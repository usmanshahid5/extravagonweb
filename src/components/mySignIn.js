                ...
                <div className="card shadow-2-strong" style={{borderRadius: "1rem",
                  ...
                  <div className="card-body p-5 text-center">
                    ...
                    <div className="form-outline mb-3">
                      <label className="form-label" htmlFor="typeEmailX-2" style={{float:"left", width:"80%"}}>Email</label>
                    ...
                    <div className="form-check d-flex justify-content-start mb-4">
                      ...
                      <label style={{fontSize:"14px"}} className="form-check-label" htmlFor="form1Example3"> Remember password </label>
                    </div>

                    <button className="btn btn-primary btn-lg btn-block" type="submit" style={{borderRadius:"10px",justifyContent:"center", borderStyle:"none", backgroundColor: "#2196F3"}}>Login</button>
                    ...
                    <hr className="my-3"/>
                      ...
                      <button className="btn btn-lg btn-block btn-primary mb-2" style={ { backgroundColor: "#3b5998", borderRadius:"10px",justifyContent:"center", borderStyle:"none" } }
                              type="submit"><i className="fab fa-facebook-f me-2"></i>Sign in with facebook
                      </button>
                    <hr className="my-2"/>
                    <NavLink
                    ...
                    >
                      <button className="btn btn-block btn-primary mb-2" style={ {backgroundColor:"rgb(59, 89, 152)", borderRadius:"10px" ,justifyContent:"center", minHeight:"40px", borderStyle:"none"} }
                              type="submit"><i className="fab fa-facebook-f me-2"></i>Not a member?
                      </button>
                    </NavLink>
